...
var _DefaultEditionContainer = _interopRequireDefault(require("./Editable/DefaultEditionContainer"));
...
var EditableInput = function EditableInput(_ref) {
  var value = _ref.value,
      label = _ref.label,
      theme = _ref.theme,
      props = _objectWithoutProperties(_ref, ["value", "label", "theme"]);
  ...
  return _react.default.createElement(_Editable.default, _extends({
    ...
    editRender: function editRender(_ref2) {
      var onChanged = _ref2.onChanged,
          value = _ref2.value;
      return _react.default.createElement(_react.default.Fragment, null, label && _react.default.createElement("span", null, label, ": "), _react.default.createElement(_Input.default, {
        value: value,
    ...
    theme: myTheme
  }, props), label && _react.default.createElement("span", null, label, ": "), current);
};
